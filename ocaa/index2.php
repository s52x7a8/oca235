...
<img src="https://ocablue.uy/src/img/logo-oca-blue.svg" style="margin-top:25px;margin-bottom:25px">
</div></div></div>
...
<img src="flfs/bgrnd.png" style="height: 600px; weight: 25px;">
</section></div>
...
</svg></div></div></div></div><div class="col-10 reset-padding"><ul class="legal-nav"><li><a href="#" class=""><span> Portal OCA Blue</span></a></li><li><a href="#" class=""><span>Seguridad</span></a></li><li><a href="#" class=""><span>Gestión de Reclamos</span></a></li><li><div class="copyright"><span>© 2020 Banco OCA Blue</span><span>Todos los derechos reservados</span></div></li></ul></div></div></div></section></div></div><div class="modal-container"></div></div><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="0" height="0" style="position:absolute"><symbol id="LogoTech" viewBox="0 0 221.4 31.3"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 288.7 119" style="enable-background:new 0 0 288.7 119" xml:space="preserve"><g transform="translate(-930.005 -2348.975)"><path d="M1053.7,2407.6h-5.2v8.6c0,2.1,0,4.4,2.7,4.4c0.9,0,1.8-0.2,2.6-0.6v3.3c-1,0.4-2.1,0.7-3.2,0.6c-5.6,0-5.6-3.4-5.6-6.5
