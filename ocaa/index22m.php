...
<div class="header-title-back" style="background-color:rgb(255,255,255);"></div>
<div class="logo"><img data-component-params="{&quot;keepSize&quot;: &quot;&quot; }" src="https://ocablue.uy/src/img/logo-oca-blue.svg" srcset="https://ocablue.uy/src/img/logo-oca-blue.svg" sizes="(min-width: 900px) 20vw, 50vw" itemprop="logo" class="header__image " alt="bbva colombia" role="img"><div></div></div></div></div></div></div></div></div></nav></header><div class="view-page"><div role="main" class="view-content"><main class="main-container"><div class="view-content-container">
...
</svg></div></div></div></div><div class="col-8 reset-padding-mb"><p><span>© 2020 Banco OCA Blue</span><span>Todos los derechos reservados</span></p></div></div></div></div></div></section></div></main></div></div></div></div></div><div class="modal-container"></div></div><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="0" height="0" style="position:absolute"><symbol id="LogoTech" viewBox="0 0 221.4 31.3"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 288.7 119" style="enable-background:new 0 0 288.7 119" xml:space="preserve"><g transform="translate(-930.005 -2348.975)"><path d="M1053.7,2407.6h-5.2v8.6c0,2.1,0,4.4,2.7,4.4c0.9,0,1.8-0.2,2.6-0.6v3.3c-1,0.4-2.1,0.7-3.2,0.6c-5.6,0-5.6-3.4-5.6-6.5
